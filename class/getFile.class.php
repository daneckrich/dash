...
class getFile {
	...
	public function __construct($id){
		...
		if(isset($id) && is_numeric($id)){
			...
			$this->name = $result['data'][0]['file_name'];
			$this->label = $result['data'][0]['file_label'];
			$this->tkn = $result['data'][0]['file_tkn'];
